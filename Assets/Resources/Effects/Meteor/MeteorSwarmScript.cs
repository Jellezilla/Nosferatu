...
namespace DigitalRuby.PyroParticles
{
    ...
    public class MeteorSwarmScript : FireBaseScript, ICollisionHandler
    {
        ...
        private Vector3 Source = new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y+100, Camera.main.transform.position.z);
        ...
        private IEnumerator SpawnMeteor()
        {
            ...
            Source = new Vector3(Camera.main.transform.position.x+10, Camera.main.transform.position.y + 10, Camera.main.transform.position.z-20);
